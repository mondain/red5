package org.red5.server.io
{
  ...
  /**
   * We use this class to make sure that an IExternalizable object
   * gets serialized into AMF0 or AMF3 correctly and deseralized
   * correctly.
   *
   * @author Joachim Bauch ( jojo@struktur.de )
   * @author Art Clarke ( aclarke@xuggle.com )
   */
  [RemoteClass(alias="org.red5.server.service.ExternalizableClass")]
  public class ExternalizableClass implements IExternalizable 
  {
    ...
    {
      Utils.ytrace("creating ExternalizableClass");
      valid = 0;
      failed = 0;
    }
    ...
    {
      Utils.ytrace("writeExternal: " + this);
    ...
    {
      Utils.ytrace("readExternal: " + this);
