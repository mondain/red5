...
{	
	...
	{		 	
	    ...
	    { 
        	...
        	if ( model.local_so.data.rtmpUri != null ) {
        		model.rtmpServer = model.local_so.data.rtmpUri;
        	}
        	if ( model.local_so.data.httpUri != null ) {
        		model.httpServer = model.local_so.data.httpUri;
        	}
        	
        	if ( model.local_so.data.httpMethod != null ) {
        		model.httpMethod = model.local_so.data.httpMethod;
        	}
        	if ( model.local_so.data.rtmpMethod != null ) {
        		model.rtmpMethod = model.local_so.data.rtmpMethod;
        	}
