...
{	
	...
	{		 	
	    ...
	    { 
			...
			model.testParams = new EchoTestData(model.tests_selection);
			model.testResults = new ArrayCollection();
			model.testIndex = 0;
			model.testsFailed = 0;
			model.globalTimer = getTimer();
			
			if (model.testParams.items.length > 0) {
